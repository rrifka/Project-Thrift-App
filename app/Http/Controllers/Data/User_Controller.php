...
class User_Controller extends Controller
{
    ...
    public function login (Request $request)
    {
        ...
        $user = Data_User::where('user_username', $credentials['user_username'])->first();
    ...
    public function register (Request $request)
    {
        $data = [
            ...
            'user_profil_url' => $request->input('profil'),
    ...
    public function create(Request $request)
    {
        ...
        Log::info('🟢 Data_User ' . $request->input('nama') . ' berhasil ditambahkan');
    ...
    public function update (Request $request, $id)
    {
        ...
        if (!$ids) {
            return redirect()->route('data_user')->with('error', 'Data user tidak ditemukan.');
        }
        $profil = $request->file('profil');
        $data = [
            'user_id' => $id,
        ...
        Log::notice('🟡 Data_User ' . $request->input('nama') . ' berhasil diubah');
    ...
    public function delete($id)
    {
        ...
        if ($user) {
            ...
            $user->delete();
            return redirect()->route('data_user')->with('deleted', 'Data user berhasil dihapus!');
        } else {
